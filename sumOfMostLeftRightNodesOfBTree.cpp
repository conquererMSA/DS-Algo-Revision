...
int main() {
    ...
    findMostLeftRightOuterNodes(root);
    if (leftMostSubTreeNode != -1 && rightMostSubTreeNode != -1) {
        cout << leftMostSubTreeNode << " " << rightMostSubTreeNode << endl;
    } else {
        cout << "The Binary Tree does not have left or right subtree" << endl;
    }
